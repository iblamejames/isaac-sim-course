...
![new file physics scene and property](assets/new.gif)
...
В Isaac Sim 4.2 параметры трения и упругости задаются через **Physics Material** — отдельный материал с физическими свойствами.
...
![Диалог сохранения — File → Save As, расширение .usd](assets/save.png)
...
Создай сферу с физикой. Создай Physics Material через `Create → Physics → Physics Material`, выставь Restitution = 0.9. Назначь материал на сферу. Подними сферу на Z = 5 и запусти — посмотри как она отскакивает. Затем поменяй Restitution на 0.0 и сравни.
...
- Для физики нужны: Physics Scene, Ground Plane, источник света
